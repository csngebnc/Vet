...
namespace Vet.Areas.Identity.Pages.Account
{
    ...
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [StringLength(100, ErrorMessage = "A jelszó legalább 2, legfeljebb 100 karakter kell, hogy legyen.", MinimumLength = 6)]
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    await _emailSender.SendEmailAsync(Input.Email, "E-mail cím megerősítése",
                        $"Kedves Felhasználónk!<br>Az alábbi emailt azért küldtük, mert regisztráltál állatorvosi rendszerünkbe.<br><br>A regisztráció véglegesítéséhez kérünk erősítsd meg az e-mail címed a következő link segítségével.<br>Az e-mail cím megerősítéséhez: <a href = '{HtmlEncoder.Default.Encode(callbackUrl)}' > kattints ide </a >.<br><br>További szép napot kívánunk! <br>Vet csapata");
